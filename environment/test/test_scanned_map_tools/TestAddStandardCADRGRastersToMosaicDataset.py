...
#------------------------------------------------------------------------------
# Name: TestAddStandardCADRGRastersToMosaicDataset.py
...
def RunTest():
    try:
        arcpy.AddMessage("Starting Test: Add Standard CADRG Rasters To Mosaic Dataset")
        ...
        arcpy.AddStandardCADRGRastersToMosaicDataset_DefenseScannedMaps(inputMosaicDataset, TestUtilities.sampleInputPath)  
        ########################################################3
