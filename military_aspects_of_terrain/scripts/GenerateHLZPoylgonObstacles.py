...
# LOCALS ========================================================
FEATURECLASSES_TO_MERGE = ["HydrographySrf","UtilityInfrastructureSrf",
                           "TransportationGroundSrf","StructureSrf",
                           "StorageSrf", "IndustrySrf","MilitarySrf",
                           "SettlementSrf"]
DEBUG = True
