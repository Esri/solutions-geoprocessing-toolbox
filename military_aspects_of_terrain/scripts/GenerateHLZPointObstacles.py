...
# LOCALS ========================================================
FEATURECLASSES_TO_MERGE = ["AeronauticPnt","HydroAidNavigationPnt",
                           "IndustryPnt","MilitaryPnt","StoragePnt",
                           "StructurePnt", "UtilityInfrastructurePnt",
...
def FeatureClassesFromWorkspace(inputTDSFeatureDataset):
    ...
    tdsFeatureClasses = arcpy.ListFeatureClasses("*", "Point",
...
def main():
    ...
    try:
        ...
        target = os.path.join(inputMAOTWorkspace, "HLZPointObstacleOutput")
