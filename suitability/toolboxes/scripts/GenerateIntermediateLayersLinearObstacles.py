...
# LOCALS ========================================================
featureClassesToMerge = ["UtilityInfrastructureCrv","StructureCrv","MilitaryCrv","PhysiographyCrv","RecreationCrv"]
newList = []
qualifierString = ""
fqClassesToMerge = []
debug = False
...
try:
    ...
    utdsFeatureClasses = arcpy.ListFeatureClasses("*","Line",os.path.basename(inputUTDSFeatureDataset))
