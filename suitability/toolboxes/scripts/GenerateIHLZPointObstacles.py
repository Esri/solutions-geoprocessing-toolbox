...
# LOCALS ========================================================
featureClassesToMerge = ["AeronauticPnt","HydroAidNavigationPnt","IndustryPnt","MilitaryPnt","StoragePnt","StructurePnt", "UtilityInfrastructurePnt", "TransportationGroundPnt"]
newList = []
qualifierString = ""
fqClassesToMerge = []
debug = False
...
try:
    ...
    tdsFeatureClasses = arcpy.ListFeatureClasses("*","Point",os.path.basename(inputTDSFeatureDataset))
    if debug == True: arcpy.AddMessage("tdsFeatureClasses: " + str(utdsFeatureClasses))
    ...
    target = os.path.join(inputMAOTWorkspace, "HLZPointObstacle")
