...
#------------------------------------------------------------------------------
# TestFastVisibilityByParameters.py
# Description: Test Publishable Tasks Toolbox > Fast Visibility By Parameters
...
try:
    ...
    psOutput = os.path.join(TestUtilities.outputGDB, "FVBParam_vshed")
    
    #Testing Path Slope
    arcpy.AddMessage("Starting Test: Fast Visibility By Parameters")
