...
try:
    ...
    fc = arcpy.CreateFeatureclass_management("in_memory", "tempfc", "POINT", None, "DISABLED", "DISABLED", sr)[0]
    ...
    arcpy.ERGByChemical_erg(inputFeatureSet, inputMaterialType, inputWindBearing, inputDayOrNight, inputLargeOrSmall, outputERGAreas, outputERGLines)
    ...
    arcpy.ERGByPlacard_erg(inputFeatureSet, inputPlacardID, inputWindBearing, inputDayOrNight, inputLargeOrSmall, outputERGAreas, outputERGLines)
