...
try:
    ...
    paths2Check = []
    paths2Check.extend([TestUtilities.toolboxesPath, TestUtilities.toolDataPath, TestUtilities.layerPath, TestUtilities.layerDataPath])
    ...
    objects2Check = []
    objects2Check.extend([TestUtilities.templateGDB, TestUtilities.toolbox]) 
