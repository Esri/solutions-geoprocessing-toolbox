...
#------------------------------------------------------------------------------
# TestFastVisibilityByCircle_MultipleInput.py
# Description: Test Publishable Tasks Toolbox > Fast Visibility By Circle with multiple input circles
...
try:
    ...
    inputCircle = os.path.join(TestUtilities.inputGDB, "FVBC_InputCircles")
    inputHeightAboveSurface = 5.0
    inputElevationURL = TestUtilities.inputElevationURL
    psOutput = os.path.join(TestUtilities.outputGDB, "FVBCircle_m_vshed")
    
    #Testing Path Slope
    arcpy.AddMessage("Starting Test: Fast Visibility By Circle - Multiple input circles")
