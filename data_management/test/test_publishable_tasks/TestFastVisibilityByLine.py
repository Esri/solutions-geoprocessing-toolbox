...
#------------------------------------------------------------------------------
# TestFastVisibilityByLine.py
# Description: Test Publishable Tasks Toolbox > Fast Visibility By Line
...
try:
    ...
    inputLine = os.path.join(TestUtilities.inputGDB, "FVBL_InputLine")
    inputDistance = "2000.0 meters"
    inputHeightAboveSurface = 5.0
    inputElevationURL = TestUtilities.inputElevationURL
    psOutput = os.path.join(TestUtilities.outputGDB, "FVBLine_vshed")
    
    #Testing Path Slope
    arcpy.AddMessage("Starting Test: Fast Visibility By Line")
    arcpy.FastVisibilityByLine_pubtask(inputLine, inputDistance, inputHeightAboveSurface, inputElevationURL, psOutput)
