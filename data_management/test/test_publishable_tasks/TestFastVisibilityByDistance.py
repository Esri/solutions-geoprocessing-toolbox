...
#------------------------------------------------------------------------------
# TestFastVisibilityByDistance.py
# Description: Test Publishable Tasks Toolbox > Fast Visibility By Distance
...
try:
    ...
    inputDistance = "3000.0 meters"
    inputHeightAboveSurface = 5.0
    inputElevationURL = TestUtilities.inputElevationURL
    psOutput = os.path.join(TestUtilities.outputGDB, "FVBDist_m_vshed")
    
    #Testing Path Slope
    arcpy.AddMessage("Starting Test: Fast Visibility By Distance")
    arcpy.FastVisibilityByDistance_pubtask(inputPoint, inputDistance, inputHeightAboveSurface, inputElevationURL, psOutput)
