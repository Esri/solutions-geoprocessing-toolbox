...
try:
    ...
    paths2Check = []
    paths2Check.extend([TestUtilities.geodatabasePath, TestUtilities.scratchPath, TestUtilities.toolboxesPath, TestUtilities.elevSourcePath])
    ...
    objects2Check = []
    objects2Check.extend([TestUtilities.toolbox, TestUtilities.inputGDB, TestUtilities.scratchGDB])
