...
try:
    ...
    arcpy.AddMessage("Starting Test: Create Source LAS Ground Elevation Mosaic (" + str(datetime.datetime.now().strftime("%m/%d/%Y %H:%M:%S")) + ")")
    ...
    arcpy.CreateSourceLASGroundElevationMosaic_LidarTools(targetGeodatabase, targetMosaicName, coordinateSystem,
                                                          rasterType, dataPath)
