...
#------------------------------------------------------------------------------
# TestLASGroundMosaic.py
# Description: Test Create Source LAS Ground Elevation Mosaic
...
try:
    ...
    targetMosaicName = "S_DTMGround"
    coordinateSystem = arcpy.SpatialReference(4326) #GCS_WGS_1984
    rasterType = "LAS"
    dataPath = TestUtilities.lasSourcePath

    arcpy.AddMessage("Starting Test: Create Source LAS Ground Elevation Mosaic")
    # CreateSourceLASGroundElevationMosaic_elevationmosaics (Target_Geodatabase, Source_Elevation_Mosaic_Dataset_Name,
    # Coordinate_System, Raster_Type,
    # Input_LAS_Files,{Coordinate_System_for_Input_Data})
    arcpy.CreateSourceLASGroundElevationosaic_LidarTools(targetGeodatabase, targetMosaicName, coordinateSystem,
                                                         rasterType, dataPath)
