...
try:
    ...
    arcpy.AddMessage("Starting Test: Create Source LAS Surface Elevation Mosaic")
    ...
    arcpy.CreateSourceLASSurfaceElevationosaic_LidarTools(targetGeodatabase, targetMosaicName, coordinateSystem,
                                                          rasterType, dataPath)
